...
function MiniProjects(){
    return(
        ...
        <div className="mt-16 text-white">
            ...
            <p className="mt-5 md:mt-10 text-xl">Projects smaller in size but fun to create.</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:space-x-5 mt-5 md:mt-10">
                ...
                <MiniDetails src={Advice} title='Coming Soon!' description='Awesome mini game at work.' />
